...
class Raw_material extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('raw_material'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Raw Material');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-cubes');
        $this->template->build('master/raw_material_v');
    }
