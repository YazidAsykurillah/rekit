...
class Dataset_weight extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_weight'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Weight');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_weight_v');
    }
