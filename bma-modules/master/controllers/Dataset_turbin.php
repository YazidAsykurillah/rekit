...
class Dataset_turbin extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_turbin'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Turbin');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_turbin_v');
    }
