...
class Dataset_time extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_time'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Time');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_time_v');
    }
