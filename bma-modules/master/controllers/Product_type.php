...
class Product_type extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('product_type'));
...
//        $this->libauth->check(__METHOD__);
        ...
        $this->template->set('icon', 'fa fa-cube');
        $this->template->build('master/product_type_v');
    }
