...
class Dataset_temperature extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_temperature'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Temperature');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_temperature_v');
    }
