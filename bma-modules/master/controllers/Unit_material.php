...
class Unit_material extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('unit_material'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Unit Material');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-th-large');
        $this->template->build('master/unit_material_v');
    }
