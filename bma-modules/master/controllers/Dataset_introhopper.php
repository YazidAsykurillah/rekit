...
class Dataset_introhopper extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_introhopper'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Intro Hopper');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_introhopper_v');
    }
