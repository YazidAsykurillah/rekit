...
class Dataset_intropowder extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_intropowder'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Intro Powder');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_intropowder_v');
    }
