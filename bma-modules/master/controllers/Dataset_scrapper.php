...
class Dataset_scrapper extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_scrapper'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Scrapper');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_scrapper_v');
    }
