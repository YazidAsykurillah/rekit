...
class Dataset_transferin extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_transferin'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Transfer In');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_transferin_v');
    }
