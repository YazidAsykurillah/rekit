...
class Dataset_transferout extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_transferout'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Transfer Out');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_transferout_v');
    }
