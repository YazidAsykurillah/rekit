...
class Dataset_impeller extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_impeller'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Impeller');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_impeller_v');
    }
