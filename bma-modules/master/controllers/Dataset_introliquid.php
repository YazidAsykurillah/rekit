...
class Dataset_introliquid extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('dataset_introliquid'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Data Set Intro Liquid');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-microchip');
        $this->template->build('master/dataset_introliquid_v');
    }
