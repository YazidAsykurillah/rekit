...
class Tank_process extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'master', 'jsfiles' => array('tank_process'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Tank Process');
        $this->template->set('tsmall', 'Master Data');
        $this->template->set('icon', 'fa fa-database');
        $this->template->build('master/tank_process_v');
    }
