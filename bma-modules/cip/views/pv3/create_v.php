<form id="mainForm" class="form-horizontal" action="<?php echo base_url(); ?>cip/pv3/store" method="POST">
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="prc_tp_transfer_line_from_pv3_to_mv2" class="control-label col-lg-8" style="text-align:left;">
                            ...
                            &nbsp;<input type="checkbox" name="prc_tp_transfer_line_from_pv3_to_mv2_check" id="prc_tp_transfer_line_from_pv3_to_mv2_check">
                        </label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="prc_tp_transfer_line_from_pv3_to_mv2" id="prc_tp_transfer_line_from_pv3_to_mv2" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">secs</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="rc_tp_transfer_line_from_pv3_to_mv2" class="control-label col-lg-8" style="text-align:left;">
                            Loop 4 : Transfer Line From PV3 to MV2
                            <input type="checkbox" name="rc_tp_transfer_line_from_pv3_mv2_check" id="rc_tp_transfer_line_from_pv3_mv2_check">
                        </label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="rc_tp_transfer_line_from_pv3_to_mv2" id="rc_tp_transfer_line_from_pv3_to_mv2" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">secs</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-md-4">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="sc_tp_transfer_line_from_pv3_to_mv2" class="control-label col-lg-8" style="text-align:left;">
                            Loop 4 : Transfer Line From PV3 to MV2
                            &nbsp;<input type="checkbox" name="sc_tp_transfer_line_from_pv3_to_mv2_check" id="sc_tp_transfer_line_from_pv3_to_mv2_check" />
                        </label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_tp_transfer_line_from_pv3_to_mv2" id="sc_tp_transfer_line_from_pv3_to_mv2" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">secs</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_pv3_hp_set_temperature" id="sc_pv3_hp_set_temperature" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">℃</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="sc_cp_tp_pv3_mm01_speed_ref" class="control-label col-lg-8" style="text-align:left;">PV-2\MM01 Speed Ref.</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_cp_tp_pv3_mm01_speed_ref" id="sc_cp_tp_pv3_mm01_speed_ref" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">RPM</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <p><strong>DRAIN PARAMETERS</strong></p>
                    <div class="form-group">
                        <label for="sc_cp_dp_pv3_mm01_speed_ref" class="control-label col-lg-8" style="text-align:left;">PV-2\MM01 Speed Ref.</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_cp_dp_pv3_mm01_speed_ref" id="sc_cp_dp_pv3_mm01_speed_ref" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">RPM</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="sc_mp_pv3_mm01_speed_ref" class="control-label col-lg-8" style="text-align:left;">PV-2\MM01 Speed Ref.</label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_mp_pv3_mm01_speed_ref" id="sc_mp_pv3_mm01_speed_ref" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">RPM</span>
                            </div>
                        </div>
                    </div>
