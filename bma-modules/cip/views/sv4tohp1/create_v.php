<form id="mainForm" class="form-horizontal" action="<?php echo base_url(); ?>cip/sv4tohp1/store" method="POST">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="prc_cp_tp_sv4_pu01_speed_ref" id="prc_cp_tp_sv4_pu01_speed_ref" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">RPM</span>
                            </div>
                        </div>
                    </div>
