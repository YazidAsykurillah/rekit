                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="prc_tp_transfer_line_from_pv1_to_mv1" class="control-label col-lg-8" style="text-align:left;">
                            ...
                            &nbsp;<input type="checkbox" name="prc_tp_transfer_line_from_pv1_to_mv1_check" id="prc_tp_transfer_line_from_pv1_to_mv1_check">
                        </label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="prc_tp_transfer_line_from_pv1_to_mv1" id="prc_tp_transfer_line_from_pv1_to_mv1" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">secs</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label for="rc_tp_transfer_line_from_pv1_to_mv1" class="control-label col-lg-8" style="text-align:left;">
                            Loop 4 : Transfer Line From PV1 to MV1
                            <input type="checkbox" name="rc_tp_transfer_line_from_pv1_mv1_check" id="rc_tp_transfer_line_from_pv1_mv1_check">
                        </label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="rc_tp_transfer_line_from_pv1_to_mv1" id="rc_tp_transfer_line_from_pv1_to_mv1" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">secs</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_tp_aodp" id="sc_tp_aodp" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">secs</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="sc_tp_transfer_line_from_pv1_to_mv1" class="control-label col-lg-8" style="text-align:left;">
                            Loop 4 : Transfer Line From PV1 to MV1
                            &nbsp;<input type="checkbox" name="sc_tp_transfer_line_from_pv1_to_mv1_check" id="sc_tp_transfer_line_from_pv1_to_mv1_check" />
                        </label>
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_tp_transfer_line_from_pv1_to_mv1" id="sc_tp_transfer_line_from_pv1_to_mv1" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">secs</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_pv1_hp_set_temperature" id="sc_pv1_hp_set_temperature" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">℃</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_cp_tp_pv1_mm01_speed_ref" id="sc_cp_tp_pv1_mm01_speed_ref" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">RPM</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_cp_dp_pv1_mm01_speed_ref" id="sc_cp_dp_pv1_mm01_speed_ref" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">RPM</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <div class="input-group">
                              <input type="text" name="sc_mp_pv1_mm01_speed_ref" id="sc_mp_pv1_mm01_speed_ref" class="form-control" placeholder="" aria-describedby="basic-addon2" value="0">
                              <span class="input-group-addon" id="basic-addon2">RPM</span>
                            </div>
                        </div>
                    </div>
