...
class Report_recipe extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'report', 'jsfiles' => array('report_recipe'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Report Recipe');
        $this->template->set('tsmall', 'Report');
        $this->template->set('icon', 'fa fa-book');
        $this->template->build('report/report_recipe_v');
    }
