...
class Report extends BMA_Controller {

    function __construct() {
        $config = array('modules' => 'report', 'jsfiles' => array('report'));
...
//        $this->libauth->check(__METHOD__);
        $this->template->title('Report Main Process');
        $this->template->set('tsmall', 'Report');
        $this->template->set('icon', 'fa fa-book');
        $this->template->build('report/report_v');
    }
